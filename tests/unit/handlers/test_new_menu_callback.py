...
class TestNewMenuCallback:
    ...
    async def test_callback_new_menu_handler_duration_picker(self, mock_event):
        ...
        with patch('handlers.button.callback.new_menu_callback.new_menu_system.show_duration_range_picker', new_callable=AsyncMock) as mock_show:
            # new_menu_callback.py 内部处理 set_duration_start
    ...
    async def test_callback_new_menu_handler_forward_search(self, mock_event):
        ...
        with patch('handlers.button.callback.new_menu_callback.new_menu_system.show_forward_search', new_callable=AsyncMock) as mock_show:
