...
class DedupConfig:
    ...
    enable_sticker_filter: bool = True  # 表情包过滤
    sticker_strict_mode: bool = False  # 是否严格(强制检查 file_unique_id)
    enable_album_dedup: bool = True     # 相册聚合去重
    album_duplicate_threshold: float = 0.8 # 相册重复阈值
