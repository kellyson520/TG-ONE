...
def _rss_local_base_urls() -> set[str]:
    hosts = Settings.parse_list_fields(settings.WEB_RATE_LIMIT_TRUSTED_IPS)
...
async def verify_local_access(request: Request):
    ...
    configured_addresses = Settings.parse_list_fields(settings.WEB_RATE_LIMIT_TRUSTED_IPS)
